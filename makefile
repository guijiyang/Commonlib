...
Commonlib.so : $(objects)
	g++ -shared -o Commonlib.so $(objects)

Task.o: MessageLoop/Task.cpp MessageLoop/Task.h
	g++ -Wall -g -c -lpthread -shared -fPIC -std=c++14 -I $(Commonlib) MessageLoop/Task.cpp 
MessageLoop.o:  MessageLoop/MessageLoop.cpp MessageLoop/MessageLoop.h MessageLoop/Private/BlockingQueue.h \
	...
	g++ -Wall -g -c -lpthread -shared -fPIC -std=c++14 -I $(Commonlib) MessageLoop/MessageLoop.cpp
TimerMessageLoop.o: Thread/Private/TimerMessageLoop.cpp Thread/Private/TimerMessageLoop.h \
	...
	g++ -Wall -g -c -lpthread -shared -fPIC -std=c++14  -I $(Commonlib) Thread/Private/TimerMessageLoop.cpp
Thread.o: Thread/Thread.cpp Thread/Thread.h Thread/Mutex.h CommonGlobal.h
	g++ -Wall -g -c -lpthread -shared -fPIC -std=c++14  -I $(Commonlib) Thread/Thread.cpp
ThreadPool.o: Thread/ThreadPool.cpp Thread/ThreadPool.h MessageLoop/Task.h Thread/Private/ThreadGroup.h \
	...
	g++ -Wall -g -c -lpthread -shared -fPIC -std=c++14  -I $(Commonlib) Thread/ThreadPool.cpp
.PHONY : clean
clean : 
